window.onload = function() {
  ...
  function go(n) {
    ...
    if (e.firstChild && e.firstChild.nodeName === 'IMG' && !e.classList.contains('image_full')) {
    ...
    } else if (e.firstChild && e.firstChild.nodeName === 'IMG' && e.classList.contains('image_full')) {
      document.body.style.background = 'linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url("' + e.firstChild.src + '")';
      document.body.style.backgroundRepeat = 'no-repeat';
